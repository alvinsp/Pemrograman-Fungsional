...
gambarku = Image.open('E:\\Kuliah Lembor\\Modul6\\assets\\logo_umm.png')  # Ganti dengan path gambar Anda
...
direktoriFont = 'E:\\Kuliah Lembor\\Modul6\\assets\\arial.ttf'  # Ganti dengan path font Anda
size = 50
...
save_path = r'E:\Kuliah Lembor\Modul6\assets\LogoUMM.png'
